...
// svg2img is an optional dependency (only needed for png/jpg output profiles) and
// pulls in its own old, prebuild-less "canvas" version, so it's required lazily
// on first use instead of at module load time.
